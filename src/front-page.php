    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12 gap-[30px]">
            <?php while ($posts->have_posts()) : $posts->the_post(); ?>
                <div class="col-span-12 lg:col-span-4 flex flex-col mb-20 text-white">
                    ...
                    <a class="mt-4 font-bold text-white flex" href="<?php the_permalink(); ?>">Zobacz więcej <svg class="ml-1 mt-[3px]" width="22" height="22" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M4.79 16.605a.75.75 0 0 1-.067-.984l.067-.077L15.397 4.938a.75.75 0 0 1 1.128.984l-.067.077L5.85 16.605a.75.75 0 0 1-1.06 0Z" fill="#fff"/><path d="M7.391 6.236a.75.75 0 0 1-.114-1.492l.11-.008 8.538-.018a.75.75 0 0 1 .744.64l.008.111-.018 8.538a.75.75 0 0 1-1.492.108l-.008-.11.016-7.786-7.784.017Z" fill="#fff"/></svg></a>
                </div>
            <?php endwhile; ?>
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12 gap-[30px]">
            <div class="col-span-12 lg:col-span-9">
                ...
                <p class="font-light mt-6 mb-6">Aktualności nowe i stare</p>
            </div>
        </div>
