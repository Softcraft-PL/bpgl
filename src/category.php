...
$args = array(
    'category_name' => $category, // Get posts from the current category
    'post_type' => 'post',
    'post_status' => 'publish',
    'posts_per_page' => 6,
    'paged' => $paged,
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12 gap-[30px]">
            <div class="col-span-12 lg:col-span-9">
                <h1 class="text-3xl lg:text-4xl font-bold mt-0 mb-20"><?php echo 'Kategoria: ' . $category; ?></h1>
            </div>
        </div>
        ...
        <div class="grid grid-cols-12 gap-[30px]">
            ...
            <div class="col-span-12 lg:col-span-4 flex flex-col mb-20">
                ...
                <time datetime="<?php echo get_the_date('c'); ?>" class="mt-2"><?php echo get_the_date(); ?></time>
                <div>Autor wpisu: <?php the_author(); ?></div>
                <?php 
                ...
                ?>
                <h2 class="text-lg font-bold mt-2 mb-2"><?php the_title(); ?></h2>
