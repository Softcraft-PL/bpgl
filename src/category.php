    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12 gap-[30px]">
            <div class="col-span-12 lg:col-span-9">
                ...
                <p class="font-light mt-6 mb-20">Czasopisma najlepsze, bo nadsd d szehjhj</p>
            </div>
        </div>

        <?php echo get_the_category(); if($categories) : ?>
        <?php foreach($categories as $category) : ?>
            ...
            <a href="/<?php echo $category->slug; ?>">Zobacz więcej</a>
